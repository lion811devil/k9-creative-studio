const CACHE_VERSION = "k9-creative-studio-v2.3.2";
const APP_SHELL = [
  "./", "./index.html", "./manifest.webmanifest",
  "./css/base.css", "./css/interface.css",
  "./css/pwa.css",
  "./css/mobile-polish.css", "./css/template-engine.css", "./css/project-manager.css", "./css/brand-kit.css", "./css/asset-center.css", "./css/ui-2.css", "./css/creative-engine.css", "./css/practical-2.2.css",
  "./js/app.js", "./js/template-engine.js", "./js/project-manager.js", "./js/brand-kit.js", "./js/asset-center.js", "./js/ui-2.js", "./js/runtime-guard.js",
