const CACHE_VERSION = "k9-creative-studio-v7.3.0";
const APP_SHELL = [
  ...
  "./css/content.css", "./css/mobile-polish.css", "./css/template-engine.css", "./css/project-manager.css", "./css/brand-kit.css", "./css/asset-center.css",
  "./js/renderer.js", "./js/app.js", "./js/template-engine.js", "./js/project-manager.js", "./js/brand-kit.js", "./js/asset-center.js", "./js/runtime-guard.js",
