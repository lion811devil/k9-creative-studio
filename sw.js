const CACHE_VERSION = "k9-creative-studio-v7.1.0";
const APP_SHELL = [
  ...
  "./css/content.css", "./css/mobile-polish.css", "./css/template-engine.css", "./css/project-manager.css",
  "./js/renderer.js", "./js/app.js", "./js/template-engine.js", "./js/project-manager.js", "./js/runtime-guard.js",
