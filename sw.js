const CACHE_VERSION = "k9-creative-studio-v7.2.1";
const APP_SHELL = [
  ...
  "./css/content.css", "./css/mobile-polish.css", "./css/template-engine.css", "./css/project-manager.css", "./css/brand-kit.css",
  "./js/renderer.js", "./js/app.js", "./js/template-engine.js", "./js/project-manager.js", "./js/brand-kit.js", "./js/runtime-guard.js",
